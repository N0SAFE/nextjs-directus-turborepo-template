...
vi.mock('next/dynamic', () => ({
  default: vi.fn((importFn, options) => {
    ...
    return vi.fn(({ children, ...props }) => (
      <div data-testid="dynamic-theme-provider" data-props={JSON.stringify(props)}>
        {children}
      </div>
    ))
  }),
...
describe('ThemeProvider Component', () => {
  ...
  it('should render with theme provider wrapper', () => {
    ...
    const provider = screen.queryByTestId('theme-provider') || screen.queryByTestId('dynamic-theme-provider')
