        ...
        Object.fromEntries([
          ...(() => {
            ...
            return Object.getOwnPropertyNames(
              ...
              n,
              typeof requests[n as keyof SafeSystemBinding.Requests] ===
              "function"
                ? (
                    requests[n as keyof SafeSystemBinding.Requests] as Function
                  ).bind(requests)
                : requests[n as keyof SafeSystemBinding.Requests],
            ]);
          })(),
          ...
          ["DirectusFields", new SafeSystemBinding.DirectusFieldItems(client)],
          ["DirectusField", new SafeSystemBinding.DirectusFieldItem(client)],

          ["DirectusFiles", new SafeSystemBinding.DirectusFileItems(client)],
          ["DirectusFile", new SafeSystemBinding.DirectusFileItem(client)],

          [
            "DirectusFolders",
            new SafeSystemBinding.DirectusFolderItems(client),
          ],
          ["DirectusFolder", new SafeSystemBinding.DirectusFolderItem(client)],
          ...
          ["DirectusPolicy", new SafeSystemBinding.DirectusPolicyItem(client)],

          [
            "DirectusPresets",
            new SafeSystemBinding.DirectusPresetItems(client),
          ],
          ["DirectusPreset", new SafeSystemBinding.DirectusPresetItem(client)],
          ...
          ["DirectusRoles", new SafeSystemBinding.DirectusRoleItems(client)],
          ["DirectusRole", new SafeSystemBinding.DirectusRoleItem(client)],
          ...
          ["DirectusUsers", new SafeSystemBinding.DirectusUserItems(client)],
          ["DirectusUser", new SafeSystemBinding.DirectusUserItem(client)],
          ...
          ["DirectusPanels", new SafeSystemBinding.DirectusPanelItems(client)],
          ["DirectusPanel", new SafeSystemBinding.DirectusPanelItem(client)],
          ...
          ["DirectusShares", new SafeSystemBinding.DirectusShareItems(client)],
          ["DirectusShare", new SafeSystemBinding.DirectusShareItem(client)],

          ["DirectusFlows", new SafeSystemBinding.DirectusFlowItems(client)],
          ["DirectusFlow", new SafeSystemBinding.DirectusFlowItem(client)],
