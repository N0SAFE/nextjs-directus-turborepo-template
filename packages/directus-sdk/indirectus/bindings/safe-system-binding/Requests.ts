...
export class Requests extends ChainableBinding {
    ...
    public aggregate<
        ...
        Output = DirectusSDK.AggregationOutput<
            Schema,
            Collection,
            Options
        >[number],
    ...
    public compareContentVersion(
        ...
        return toSafe(
            this.request(DirectusSDK.compareContentVersion(...params))
        )
    }
    ...
    public generateHash(
        ...params: Parameters<typeof DirectusSDK.generateHash>
    ) {
    ...
    public generateTwoFactorSecret(
        ...
        return toSafe(
            this.request(DirectusSDK.generateTwoFactorSecret(...params))
        )
    }
    public importFile<
    ...
    public promoteContentVersion<Collection extends keyof Schema>(
        ...
        return toSafe(
            this.request(DirectusSDK.promoteContentVersion(...params))
        )
    }
    public randomString(
        ...params: Parameters<typeof DirectusSDK.randomString>
    ) {
    ...
    public registerUser(
        ...params: Parameters<typeof DirectusSDK.registerUser>
    ) {
    ...
    public serverHealth(
        ...params: Parameters<typeof DirectusSDK.serverHealth>
    ) {
