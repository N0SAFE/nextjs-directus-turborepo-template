...
export class DirectusFileItems extends ChainableBinding {
  ...
  >(query?: Query): Promise<ToSafeOutput<Output>> {
    return toSafe(
      this.request(readDirectusFileItems(query)) as unknown as Promise<Output>,
    );
  }
  ...
  async remove<Output = void>(
    ...
    return toSafe(
      this.request(deleteDirectusFileItems(keys)) as unknown as Promise<Output>,
    );
  }
  ...
  >(options: Options): Promise<ToSafeOutput<Output>> {
    return toSafe(
      this.request(aggregateDirectusFileItems<Options>(options)).then(
        (a) => a?.[0],
      ) as unknown as Promise<Output>,
    );
  }
...
export class DirectusFileItem extends ChainableBinding {
  ...
  async readArrayBuffer(
    ...
    return await toSafe(this.request(readDirectusFileArrayBuffer(key, query)));
  }
  ...
  async readBlob(
    ...
    return await toSafe(this.request(readDirectusFileBlob(key, query)));
  }
  ...
  async readStream(
    ...
    return await toSafe(this.request(readDirectusFileStream(key, query)));
  }
  ...
  async remove<Output = void>(
    ...
    return toSafe(
      this.request(deleteDirectusFileItem(key)) as unknown as Promise<Output>,
    );
  }
}
