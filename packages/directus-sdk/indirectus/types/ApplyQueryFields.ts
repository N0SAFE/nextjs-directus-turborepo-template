import type { DirectusIdType } from "../utils";
import type {
  FieldOutputMap,
  FieldsWildcard,
...
type RemoveDuplicateIdAndItem<T> = {
  [Key in keyof T]: Exclude<T[Key], null | undefined> extends unknown[]
...
type ApplyQueryFields<
  ...
  RelationalKeys extends keyof RelationalFields = RelationalFields extends never
    ? never
        ...
        : {
            [Field in keyof RelationalFields]: Field extends keyof CollectionItem
              ? Extract<
                ...
                ? RelationNullable<
                    CollectionItem[Field],
                    RelatedCollection extends unknown[]
