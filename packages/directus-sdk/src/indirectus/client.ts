...
export const schema = () => {
    return <Schema>(client: Directus.DirectusClient<Schema>): TypedClient => {
        ...
        return Object.fromEntries([
            ...
            [
                'DirectusFields',
                new SystemBinding.DirectusFieldItems(client as any),
            ],
            [
                'DirectusField',
                new SystemBinding.DirectusFieldItem(client as any),
            ],

            [
                'DirectusFiles',
                new SystemBinding.DirectusFileItems(client as any),
            ],
            ['DirectusFile', new SystemBinding.DirectusFileItem(client as any)],

            [
                'DirectusFolders',
                new SystemBinding.DirectusFolderItems(client as any),
            ],
            [
                'DirectusFolder',
                new SystemBinding.DirectusFolderItem(client as any),
            ],
            ...
            [
                'DirectusPolicy',
                new SystemBinding.DirectusPolicyItem(client as any),
            ],

            [
                'DirectusPresets',
                new SystemBinding.DirectusPresetItems(client as any),
            ],
            [
                'DirectusPreset',
                new SystemBinding.DirectusPresetItem(client as any),
            ],
            ...
            [
                'DirectusRoles',
                new SystemBinding.DirectusRoleItems(client as any),
            ],
            ...
            [
                ...
                (query: any) => {
                    return client.request(
                        SystemBinding.readDirectusSettings(query)
                    )
                },
            ],
            ...
            [
                'DirectusUsers',
                new SystemBinding.DirectusUserItems(client as any),
            ],
            ...
            [
                'DirectusWebhook',
                new SystemBinding.DirectusWebhookItem(client as any),
            ],
            ...
            [
                'DirectusPanels',
                new SystemBinding.DirectusPanelItems(client as any),
            ],
            [
                'DirectusPanel',
                new SystemBinding.DirectusPanelItem(client as any),
            ],
            ...
            [
                'DirectusShares',
                new SystemBinding.DirectusShareItems(client as any),
            ],
            [
                'DirectusShare',
                new SystemBinding.DirectusShareItem(client as any),
            ],

            [
                'DirectusFlows',
                new SystemBinding.DirectusFlowItems(client as any),
            ],
