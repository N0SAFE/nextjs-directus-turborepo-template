...
const getUserFromNormalSDK = () => {
    return directus.request(DirectusSDK.readUsers())
}
const getUserFromBindingClient = () => {
    return directus.readUsers()
}

type userFromNormalSDK = Pretify<
    Awaited<ReturnType<typeof getUserFromNormalSDK>>[number]
>
type userFromBindingCLient = Pretify<
    Awaited<ReturnType<typeof getUserFromBindingClient>>[number]
>
...
type bindedAndSdkTypeEqualOrUser = IsEqual<
    ReturnType<typeof getUserFromNormalSDK>,
    ReturnType<typeof getUserFromBindingClient>
>
