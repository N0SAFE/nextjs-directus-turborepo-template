...
# Test script to verify Docker Compose project naming works correctly
# This script demonstrates how the COMPOSE_PROJECT_NAME variable affects resource naming

echo "🧪 Testing Docker Compose Project Naming"
echo "========================================"

# Test 1: Default naming (when COMPOSE_PROJECT_NAME is not set)
echo "📋 Test 1: Default project naming"
unset COMPOSE_PROJECT_NAME
echo "COMPOSE_PROJECT_NAME: ${COMPOSE_PROJECT_NAME:-<not set>}"
echo "Expected container names: nextjs-directus-api-dev, nextjs-directus-web-dev"
echo ""

# Test 2: Custom project naming
echo "📋 Test 2: Custom project naming"
export COMPOSE_PROJECT_NAME="my-blog"
echo "COMPOSE_PROJECT_NAME: $COMPOSE_PROJECT_NAME"
echo "Expected container names: my-blog-api-dev, my-blog-web-dev"
echo ""

# Test 3: Another custom project
echo "📋 Test 3: Another custom project"
export COMPOSE_PROJECT_NAME="ecommerce-store"
echo "COMPOSE_PROJECT_NAME: $COMPOSE_PROJECT_NAME"
