  ...
  return (
    <div className="h-full w-full flex justify-center items-center">
      <Card className="w-fit min-w-[450px]">
        ...
        <CardContent className="flex gap-4 lg:flex-row flex-col">
          <Card className="min-w-[380px] w-full">
            <CardHeader>
          ...
          <Card className="w-full min-w-[380px]">
            ...
            <CardContent>
              <p>
                <strong>Status:</strong>{" "}
                {directusMe ? "authenticated" : "unauthenticated"}
              </p>
              <p>
                <strong>Name:</strong>{" "}
              ...
              <p>
                <strong>Email:</strong> {directusMe?.email || "Unknown"}
              </p>
            </CardContent>
          </Card>
        </CardContent>
